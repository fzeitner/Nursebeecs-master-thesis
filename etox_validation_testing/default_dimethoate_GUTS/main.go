...
func main() {
	...
	pe.GUTSParams = params_etox.GUTSParams{ // param estimates for dimethoate; taken from Baas et al. 2022
		...
		// IT params
		Kd_IT: 0.035,  // Dominant rate constant for the reduced-IT-model
		MW_IT: 0.0064, // Median of the distribution of thresholds for calculating IT threshold distribution
		F_S:   2.2,    // Fraction spread in distribution of thresholds; used to calculate beta for the threshold distribution calc
