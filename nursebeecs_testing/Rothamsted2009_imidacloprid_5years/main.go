...
func main() {
	...
	pe.ETOXparams = params_etox.ETOXparams{
		...
		PPPname:                "imidacloprid", // Identifier for the PPP used.
		PPPconcentrationNectar: 990 / 10,
		PPPconcentrationPollen: 27150 / 10,
		PPPcontactExposure:     0.3 / 10, // kg/ha; contact exposure at patch; 0.035 kg/ha of imidacloprid was advised somewhere against potato beeles; this is just a test
	...
	pe.Toxicityparams = params_etox.Toxicityparams{ // adult LD50 backed by EFSA assessment for honey bees; slope unknown for now
		ForagerOralLD50:  0.0037, // imidacloprid
		ForagerOralSlope: 3.28,   // imidacloprid
		HSuptake:         0.1,    //

		// ContactLD50 is backed by PPDB; Slope is not estimated yet and larval data is missing atm
		ForagerContactLD50:  0.081, // imidacloprid
		ForagerContactSlope: 1.08,  // imidacloprid

		LarvaeOralLD50:  1000, // imidacloprid
		LarvaeOralSlope: 1000, // imidacloprid
