...
// NurseBeecsDefault sets up the default NurseBeECS_ecotox model with the standard sub-models.
func NurseBeecsDefault(p params.Params, pe params_etox.Params_etox, app *app.App) *app.App {
