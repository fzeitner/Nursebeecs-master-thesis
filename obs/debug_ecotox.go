...
// DebugEcotox is a row observer for several colony structure variables and ETOX doses,
//
// Primarily meant for testing of Nursebeecs vs beecs.
...
func (o *DebugEcotox) Values(w *ecs.World) []float64 {
	...
	o.data[16] = float64(o.storesEtox.Pollenconcbeforeeating)
	o.data[17] = float64(o.storesEtox.Nectarconcbeforeeating)
