...
func (o *DebugPollenCons) Header() []string {
	return []string{"DailyForagingPeriod", "HoneyEnergyStore", "PollenStore_g", "TotalEggs", "TotalLarvae", "TotalPupae", "TotalIHbees", "TotalForagers", "ProteinFactorNurses", "DailyHoneyConsumption_mug", "DailyPollenConsumption_g", "TotalDroneEggs", "TotalDroneLarvae", "TotalDronePupae", "TotalDrones", "TotalPop"}
}
